          ...
          <div className="p-6">
            <div className="mb-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <p className="text-lg text-gray-800 font-medium">질문: {stepInfo.question}</p>
              </div>
            </div>
                ...
                <div className="bg-gradient-to-r from-orange-50 to-blue-50 p-6 rounded-lg border-2 border-orange-200">
                  <div className="text-center mb-4">
                    <h3 className="text-lg font-bold text-orange-800">
                      {currentStep === 'see' && 'I Used to Think...'}
                      {currentStep === 'think' && 'Now I Think...'}
                      {currentStep === 'wonder' && 'Why Changed?'}
                    </h3>
                ...
                <div className="bg-gradient-to-r from-green-50 to-yellow-50 p-6 rounded-lg border-2 border-green-200">
                  <div className="text-center mb-4">
                    <h3 className="text-lg font-bold text-green-800">
                      {currentStep === 'see' && 'Think'}
                      {currentStep === 'think' && 'Puzzle'}
                      {currentStep === 'wonder' && 'Explore'}
                    </h3>
                ...
                <div className="bg-gradient-to-r from-indigo-50 to-purple-50 p-6 rounded-lg border-2 border-indigo-200">
                  <div className="text-center mb-4">
                    <h3 className="text-lg font-bold text-indigo-800">
                      {currentStep === 'see' && 'Viewpoints'}
                      {currentStep === 'think' && 'Perspective'}
                      {currentStep === 'wonder' && 'Questions'}
                    </h3>
                ...
                <div className="bg-gradient-to-r from-cyan-50 to-teal-50 p-6 rounded-lg border-2 border-cyan-200">
                  <div className="text-center mb-4">
                    <h3 className="text-lg font-bold text-cyan-800">
                      {currentStep === 'see' && 'Connect'}
                      {currentStep === 'think' && 'Extend'}
                      {currentStep === 'wonder' && 'Challenge'}
                    </h3>
              ...
              {template.routine_type === 'see-think-wonder' && (
                <div className="bg-gradient-to-r from-blue-50 to-green-50 p-6 rounded-lg border-2 border-blue-200">
                  <div className="text-center mb-4">
                    <h3 className="text-lg font-bold text-blue-800">
                      {currentStep === 'see' && 'See'}
                      {currentStep === 'think' && 'Think'}
                      {currentStep === 'wonder' && 'Wonder'}
                    </h3>
                  </div>
                  <textarea
                    value={responses[currentStep]}
